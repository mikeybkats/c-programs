...
char *encryptText(char *plaintext, char *cipherText){
  ...
  char *encryptedOutput = plaintext;
...
int main(int argc, char *argv[])
{
  ...
  /*const char wordToEncrypt = collectPlaintext();*/
  /*printf("%s\n", wordToEncrypt);*/
  string wordToEncrypt = GetString();
